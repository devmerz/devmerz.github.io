...
<p>
    <li>
        <strong>ERPSYS:</strong> Sistema de planificacion de recursos empresariales.
    </li>
    <li>
        <strong>SARH:</strong> Sistema de Administración de Recursos Humanos.
    </li>
    <li>
        <strong>SEAP:</strong> Sistema de Efectividad de las Acciones de Promoción.
    </li>
    <li>
        <strong>OROS:</strong>Plataforma informativa OROS
    </li>
    <li>
        Sistema de gestion de proyectos para bufetes de abogados.
    </li>
    <li>
        Sistema y página web de contratacion de personal para trabajos del hogar.
    </li>
    <li>
